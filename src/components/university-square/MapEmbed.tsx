    ...
    <section id="map" className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="map-container rounded-xl overflow-hidden" style={{ border: '1px solid var(--map-border)' }}>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2848.5!2d26.1000!3d44.4360!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDTCsDI1JzE2LjEiTiAyNsKwMDYnMDAuNCJF!5e0!3m2!1sen!2sro!4v1"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
