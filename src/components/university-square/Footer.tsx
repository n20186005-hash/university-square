        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#gallery-section" className="block text-sm" style={{ color: 'var(--text-secondary)' }}>{t('gallery') || 'Gallery'}</a>
              <a href="#reviews" className="block text-sm" style={{ color: 'var(--text-secondary)' }}>{t('reviews') || 'Reviews'}</a>
              <a href="#map" className="block text-sm" style={{ color: 'var(--text-secondary)' }}>{t('map') || 'Map'}</a>
            </div>
          </div>
