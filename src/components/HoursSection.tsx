      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-medium mb-1" style={{ color: 'var(--text-primary)' }}>{t('shops')}</h3>
              <div className="space-y-1" style={{ color: 'var(--text-secondary)' }}>
                <p><span style={{ color: 'var(--text-muted)' }}>{t('daily')}:</span> {t('dailyTime')}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-lg border" style={{ background: 'var(--bg-tertiary)', borderColor: 'var(--border-color)' }}>
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium mb-1" style={{ color: 'var(--text-primary)' }}>{t('tip')}</h4>
                <p style={{ color: 'var(--text-secondary)' }}>{t('tipContent')}</p>
              </div>
            </div>
          </div>
        </div>
